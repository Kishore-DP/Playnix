__d(function(g,r,i,a,m,_e,_d){"use strict";Object.defineProperty(_e,'__esModule',{value:!0}),_e.initViewCount=v,_e.startWebActivity=function(){if('undefined'==typeof window)return;if(v(),p())return void _();const t=setTimeout(_,6e3);['pointerdown','keydown','touchstart'].forEach(e=>addEventListener(e,()=>{clearTimeout(t),_()},{once:!0}))};var t=r(_d[0]),e=r(_d[1]),n=r(_d[2]);const o='Playnix';let c=null;function s(){if(!c){const o=(0,t.getApps)().length?(0,t.getApp)():(0,t.initializeApp)(n.firebaseConfig);c=(0,e.getFirestore)(o)}return c}function u(){let t=localStorage.getItem('pnx_visitor_id');return t||(t='v_'+Date.now().toString(36)+Math.random().toString(36).slice(2,10),localStorage.setItem('pnx_visitor_id',t)),t}async function l(){const t=(0,e.doc)(s(),'counters','anonUser');return`UnknownUser${await(0,e.runTransaction)(s(),async e=>{const n=await e.get(t),o=(n.exists()&&n.data().count||0)+1;return e.set(t,{count:o}),o})}`}async function d(){let t=localStorage.getItem('pnx_identity');return t||(t=await l(),localStorage.setItem('pnx_identity',t)),t}function f(t){const e=new Date;return`${t}_${`${e.getDate()}${e.toLocaleString('en-US',{month:'long'})}`}${Math.random().toString(36).slice(2,7)+Date.now().toString(36).slice(-3)}`}function w(t){return f(t)}function p(){const t=location.hostname;return!0===navigator.webdriver||'localhost'===t||'127.0.0.1'===t||'[::1]'===t||'0.0.0.0'===t||''===t}async function v(){const t=(0,e.doc)(s(),'counters','pageViews');try{if(localStorage.getItem('pnx_viewcounted')||p()){const n=await(0,e.getDoc)(t);return n.exists()&&n.data().count||0}const n=await(0,e.runTransaction)(s(),async e=>{const n=await e.get(t),o=(n.exists()&&n.data().count||0)+1;return e.set(t,{count:o}),o});return localStorage.setItem('pnx_viewcounted','1'),n}catch(t){return console.error('view count failed',t),null}}let y=!1;async function _(){if(!y){y=!0;try{const t=p()?'Claude':await d(),n=p()?'Claude':f(t);await(0,e.setDoc)((0,e.doc)(s(),o,w(t)),{name:n,visitorId:u(),at:(0,e.serverTimestamp)(),page:location.pathname+location.search,referrer:document.referrer||'direct',lang:navigator.language||'',ua:navigator.userAgent.slice(0,180)})}catch(t){console.error('visit log failed',t),y=!1}}}},1369,[804,1370,808]);
__d(function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,'__esModule',{value:!0});var t=r(d[0]);Object.keys(t).forEach(function(n){'default'===n||Object.prototype.hasOwnProperty.call(e,n)||Object.defineProperty(e,n,{enumerable:!0,get:function(){return t[n]}})})},1370,[1371]);
