__d(function(g,r,i,a,m,_e,_d){"use strict";Object.defineProperty(_e,'__esModule',{value:!0}),_e.initViewCount=h,_e.startWebActivity=function(t){if('undefined'==typeof window)return;if(_=t??null,h(),y())return void S();const e=setTimeout(S,6e3);['pointerdown','keydown','touchstart'].forEach(t=>addEventListener(t,()=>{clearTimeout(e),S()},{once:!0}))},_e.logFeedback=async function(t){if('undefined'==typeof window)return!1;const n=(t.text||'').trim();if(!n&&'number'!=typeof t.rating)return!1;const o=(t.username||'').trim()||'Anonymous';try{return await(0,e.setDoc)((0,e.doc)(l(),c,v(o)),{username:o,feedback:n,...'number'==typeof t.rating?{rating:t.rating}:{},visitorId:d(),at:(0,e.serverTimestamp)(),page:location.pathname+location.search,lang:navigator.language||'',ua:navigator.userAgent.slice(0,180)}),!0}catch(t){return console.error('feedback log failed',t),!1}};var t=r(_d[0]),e=r(_d[1]),n=r(_d[2]);const o='Playnix',c='feedbacks',s='playnix';let u=null;function l(){if(!u){const o=(0,t.getApps)().length?(0,t.getApp)():(0,t.initializeApp)(n.firebaseConfig);u=(0,e.getFirestore)(o,s)}return u}function d(){let t=localStorage.getItem('pnx_visitor_id');return t||(t='v_'+Date.now().toString(36)+Math.random().toString(36).slice(2,10),localStorage.setItem('pnx_visitor_id',t)),t}async function f(){const t=(0,e.doc)(l(),'counters','anonUser');return`UnknownUser${await(0,e.runTransaction)(l(),async e=>{const n=await e.get(t),o=(n.exists()&&n.data().count||0)+1;return e.set(t,{count:o}),o})}`}async function p(){let t=localStorage.getItem('pnx_identity');return t||(t=await f(),localStorage.setItem('pnx_identity',t)),t}function w(t){const e=new Date;return`${t}_${`${e.getDate()}${e.toLocaleString('en-US',{month:'long'})}`}${Math.random().toString(36).slice(2,7)+Date.now().toString(36).slice(-3)}`}function v(t){return w(t)}function y(){const t=location.hostname;return!0===navigator.webdriver||'localhost'===t||'127.0.0.1'===t||'[::1]'===t||'0.0.0.0'===t||''===t}async function h(){const t=(0,e.doc)(l(),'counters','pageViews');try{if(localStorage.getItem('pnx_viewcounted')||y()){const n=await(0,e.getDoc)(t);return n.exists()&&n.data().count||0}const n=await(0,e.runTransaction)(l(),async e=>{const n=await e.get(t),o=(n.exists()&&n.data().count||0)+1;return e.set(t,{count:o}),o});return localStorage.setItem('pnx_viewcounted','1'),n}catch(t){return console.error('view count failed',t),null}}let _=null,x=!1;async function S(){if(!x){x=!0;try{const t=(_?.()||'').trim(),n=y()?'Claude':t||await p(),c=y()?'Claude':w(n);await(0,e.setDoc)((0,e.doc)(l(),o,v(n)),{name:c,visitorId:d(),at:(0,e.serverTimestamp)(),page:location.pathname+location.search,referrer:document.referrer||'direct',lang:navigator.language||'',ua:navigator.userAgent.slice(0,180)})}catch(t){console.error('visit log failed',t),x=!1}}}},1376,[1623,1755,850]);
__d(function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,'__esModule',{value:!0});var t=r(d[0]);Object.keys(t).forEach(function(n){'default'===n||Object.prototype.hasOwnProperty.call(e,n)||Object.defineProperty(e,n,{enumerable:!0,get:function(){return t[n]}})})},1755,[1756]);
