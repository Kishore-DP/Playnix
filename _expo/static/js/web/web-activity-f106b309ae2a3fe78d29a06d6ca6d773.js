__d(function(g,r,i,a,m,_e,_d){"use strict";Object.defineProperty(_e,'__esModule',{value:!0}),_e.initViewCount=_,_e.startWebActivity=function(t){if('undefined'==typeof window)return;if(h=t??null,_(),v())return void S();const e=setTimeout(S,6e3);['pointerdown','keydown','touchstart'].forEach(t=>addEventListener(t,()=>{clearTimeout(e),S()},{once:!0}))},_e.logFeedback=async function(t){if('undefined'==typeof window)return!1;const n=(t.text||'').trim();if(!n&&'number'!=typeof t.rating)return!1;const o=(t.username||'').trim()||'Anonymous';try{return await(0,e.setDoc)((0,e.doc)(l(),c,y(o)),{username:o,...'number'==typeof t.rating?{rating:t.rating}:{},feedback:n}),!0}catch(t){return console.error('feedback log failed',t),!1}};var t=r(_d[0]),e=r(_d[1]),n=r(_d[2]);const o='Playnix',c='feedbacks',s='playnix';let u=null;function l(){if(!u){const o=(0,t.getApps)().length?(0,t.getApp)():(0,t.initializeApp)(n.firebaseConfig);u=(0,e.getFirestore)(o,s)}return u}function d(){let t=localStorage.getItem('pnx_visitor_id');return t||(t='v_'+Date.now().toString(36)+Math.random().toString(36).slice(2,10),localStorage.setItem('pnx_visitor_id',t)),t}async function f(){const t=(0,e.doc)(l(),'counters','anonUser');return`UnknownUser${await(0,e.runTransaction)(l(),async e=>{const n=await e.get(t),o=(n.exists()&&n.data().count||0)+1;return e.set(t,{count:o}),o})}`}async function w(){let t=localStorage.getItem('pnx_identity');return t||(t=await f(),localStorage.setItem('pnx_identity',t)),t}function p(t){const e=new Date;return`${t}_${`${e.getDate()}${e.toLocaleString('en-US',{month:'long'})}`}${Math.random().toString(36).slice(2,7)+Date.now().toString(36).slice(-3)}`}function y(t){return p(t)}function v(){const t=location.hostname;return!0===navigator.webdriver||'localhost'===t||'127.0.0.1'===t||'[::1]'===t||'0.0.0.0'===t||''===t}async function _(){const t=(0,e.doc)(l(),'counters','pageViews');try{if(localStorage.getItem('pnx_viewcounted')||v()){const n=await(0,e.getDoc)(t);return n.exists()&&n.data().count||0}const n=await(0,e.runTransaction)(l(),async e=>{const n=await e.get(t),o=(n.exists()&&n.data().count||0)+1;return e.set(t,{count:o}),o});return localStorage.setItem('pnx_viewcounted','1'),n}catch(t){return console.error('view count failed',t),null}}let h=null,x=!1;async function S(){if(!x){x=!0;try{const t=(h?.()||'').trim(),n=v()?'Claude':t||await w(),c=v()?'Claude':p(n);await(0,e.setDoc)((0,e.doc)(l(),o,y(n)),{name:c,visitorId:d(),at:(0,e.serverTimestamp)(),page:location.pathname+location.search,referrer:document.referrer||'direct',lang:navigator.language||'',ua:navigator.userAgent.slice(0,180)})}catch(t){console.error('visit log failed',t),x=!1}}}},1376,[1623,1755,850]);
